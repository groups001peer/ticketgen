      ...
      <div className="bg-white rounded-xl p-4 shadow space-y-3">
        ...
        <button
          ...
          onClick={() => {
            ...
            // build a prefilled Telegram share message with points and USD amount
            const text = `Hello, I'd like to buy ${credits} points (${usdAmount.toLocaleString('en-US', { style: 'currency', currency: 'USD' })}). ${note || ''}`;
            
            // Build the Telegram link to open a DM to you directly with the pretext
            // Using a specific target (t.me/share/url?url=) or (t.me/YOUR_ID?text=) for direct DM
